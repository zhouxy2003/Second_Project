  ...
  <div class="login_box">
      <form class="form_container">
        ...
        <div class="title_container">
          <p class="title">欢迎登录Http接口管理系统</p>
          <span class="subtitle">Please enter your account password to log in to the system.</span>
        </div>
        <br>
        <div class="input_container">
          <label class="input_label" for="text">Account</label>
          ...
          <input placeholder="Enter your account name" title="input there" name="input-name" type="text" class="input_field" id="email_field" v-model.trim="account">
        </div>
        <div class="input_container">
          ...
          <input placeholder="Password" title="Inpit title" name="input-name" type="password" class="input_field" id="password_field"  v-model.number="password">
        </div>
        <button title="Sign In" type="submit" class="sign-in_btn" @click.prevent="showData" >
          <span>Sign In</span>
        </button>
        ...
        <button title="Sign In" type="submit" class="sign-in_apl_1">
 ...
 methods:{
    showData(){
     ...
     if(this.account===this.user_name&&this.password===this.user_password){
       ...
       this.$alert(
           '<h3 style="color: red">账号信息或者密码输入错误</h3>',
           '信息错误',
           {
